    ...
    if (type === 'weather') {
        ...
        wrapper.innerHTML = darkSpinner +
            '<div style="width:100%;height:100%;overflow:hidden;border-radius:8px;">' +
                '<iframe src="https://faa.maps.arcgis.com/apps/webappviewer/index.html?id=9c2e4f7b9c264f9c96f8d8e89eb0ceb3&center=' + lng + ',' + lat + '&level=12" ' +
                    'style="width:100%;height:100%;border:none;filter:invert(1) hue-rotate(180deg) brightness(0.9) contrast(1.1);" ' +
                    'allowfullscreen onload="hideMapSpinner()"></iframe>' +
            '</div>' +
